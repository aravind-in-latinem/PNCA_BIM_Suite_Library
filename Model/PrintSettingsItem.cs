    ...
    {
        public class PrintSettingsItem : ObservableObject
        {
            ...
            public PrintSetting DbSetting { get; }
            public bool IsInSession { get; }
            public PrintSettingsItem()
            {
                PaperOrientation = PageOrientationType.Landscape;
            }
            public PrintSettingsItem(string name)
            {
                Name = name;
                IsInSession = true;
            }

            public PrintSettingsItem(PrintSetting setting) : this()
            {
                Name = setting?.Name;
                DbSetting = setting;
                IsInSession = false;
